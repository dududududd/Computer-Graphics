...
OpenCylinder::OpenCylinder(const double _y0, const double _y1, const double _radius)
...
BBox OpenCylinder::get_bounding_box(void)
{
	double delta = 0.0001;
...
BBox OpenCylinder::set_bounding_box(void)
{
