...
void World::build(void)
{
	...
	reflective_ptr1->set_kd(0.95);
	reflective_ptr1->set_cd(RGBColor(1, 0.6, 0));
	reflective_ptr1->set_ks(0.5);
	reflective_ptr1->set_exp(20);
	reflective_ptr1->set_kr(0.5);
	reflective_ptr1->set_cr(RGBColor(1, 0.6, 0));

	char* file_name = ".\\PLYFiles\\dragon.ply";
	Grid* grid_ptr = new Grid(new Mesh);
	grid_ptr->read_flat_triangles(file_name);	//平面着色	
	//grid_ptr->read_smooth_triangles(file_name);	//光滑着色	
	...
	instance_ptr->scale(70.0, 70.0, 70.0);
	instance_ptr->rotate_y(60);
	instance_ptr->translate(0.0, -7, 0.0);
	...
	reflective_ptr2->set_cr(RGBColor(0.9, 0.9, 0.9));  // light green
	...
	rectangle_ptr2->set_material(reflective_ptr3);
	...
	rectangle_ptr5->set_material(reflective_ptr5);
	...
	reflective_ptr6->set_kr(1);
	reflective_ptr6->set_cr(RGBColor(1, 1, 1));  // lemon
	...
	rectangle_ptr4->set_material(reflective_ptr6);
