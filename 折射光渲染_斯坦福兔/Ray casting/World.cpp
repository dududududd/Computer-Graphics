...
void World::build(void)
{
	...
	ambient_ptr1->set_color(RGBColor(1.0));
	ambient_ptr1->scale_radiance(0.25);
	//ambient_ptr1->scale_radiance(0.75);
	//this->ambient_ptr = ambient_ptr1;
	...
	//char* fileName = ".\\PLYFiles\\Bunny10K.ply"; 	// 10000 triangles
	//char* fileName = ".\\PLYFiles\\Bunny16K.ply"; 	// 16000 triangles
	char* fileName = ".\\PLYFiles\\Bunny69K.ply"; 	// 69000 triangles
	...
	big_bunny_ptr->set_bounding_box();
	...
	matte_ptr->set_cd(RGBColor(0.0, 0.75, 0.75));
	...
	rectangle_ptr->set_material(matte_ptr);
